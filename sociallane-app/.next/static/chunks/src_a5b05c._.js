...
function Home() {
    ...
    const handleCreateClient = async ()=>{
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSubscription"])(subscriptionData);
            await fetchSubscriptions();
...
_s(Home, "rURLxXFbpBc0vokeRa7Ntzcss9E=", false, function() {
    return [
